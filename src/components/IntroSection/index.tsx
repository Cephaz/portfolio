...
const IntroSection = () => {
  return (
    <div
      className="h-screen flex flex-col justify-center max-w-screen-lg mx-auto"
      id="introsection"
    >
      <div className="grid md:grid-cols-2 place-items-center gap-8">
        <div className="flex flex-col">
          ...
          <div className="flex flex-row justify-center items-center gap-6 my-4 md:mb-0">
            <a
              href="https://drive.google.com/uc?export=download&id=1hMtxFqhJnZtJp2HEASyJVJDBf96zvd61"
              download
            >
              <button className="z-10 cursor-pointer font-bold md:w-auto p-4 border border-primary-400 rounded-xl transition duration-300 ease-in-out transform hover:bg-primary-400 hover:text-white hover:scale-105">
                Download CV
              </button>
            </a>
        ...
        <div className="relative">
          <img
            src={MemojiSvg}
            className="w-[300px] md:w-[450px] z-10 relative"
            alt="Memoji"
          />
