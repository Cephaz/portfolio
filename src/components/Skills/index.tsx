...
const Skills = () => {
  return (
    <div
      className="h-screen max-w-screen-xl mx-auto flex flex-col justify-center px-4 text-text-900 pb-8 md:py-12"
      id="skills"
    >
      ...
      <div className="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="border border-primary-600 p-6 rounded-lg bg-blue-500/20 shadow-lg w-full md:w-1/2"
          >
